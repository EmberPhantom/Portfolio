...
import { Settings, KeyRound, Brain, Camera, Save, Loader2, CheckCircle, Plus, Trash2, Eye, EyeOff, ExternalLink, Shield, Sliders } from 'lucide-react';
...
// ── Site Control Configuration Link ───────────────────
function SiteControlLink() {
  return (
    <Section title="Site Control Config" icon={Sliders}>
      <p className="text-sm text-text-muted mb-6 leading-relaxed">
        Configure dynamic site-wide variables, contact channels, public socials, active AI models, and featured homepage content.
      </p>
      <Link 
        href="/admin/settings/site"
        className="inline-flex items-center gap-3 px-6 py-3 bg-accent text-bg text-xs font-black rounded-xl hover:bg-accent/80 transition-all uppercase tracking-widest shadow-lg shadow-accent/15"
      >
        Configure Site Variables <ExternalLink className="w-4 h-4" />
      </Link>
    </Section>
  );
}
